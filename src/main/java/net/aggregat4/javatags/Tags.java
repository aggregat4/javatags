...
public class Tags {
    ...
    public static final TypedAttributes.TypedAttribute[] NO_ATTRIBUTES = new TypedAttributes.TypedAttribute[0];

    public static Tag text(String content) { return new Text(content); }

    public static NamedTag html(TypedAttributes.TypedAttribute... attributes) { return new NamedTag(TagType.html, attributes); }
    ...
    public static NamedTag body(TypedAttributes.TypedAttribute ... attributes) { return new NamedTag(body, attributes); }
    public static NamedTag body(Tag... children) { return body(NO_ATTRIBUTES).content(children); }

    public static NamedTag h1(TypedAttributes.TypedAttribute ... attributes) { return new NamedTag(h1, attributes); }
    ...
    public static NamedTag p(TypedAttributes.TypedAttribute ... attributes) { return new NamedTag(p, attributes); }
    ...
    public static NamedTag p(TypedAttributes.TypedAttribute [] attributes, String content) { return new NamedTag(p, attributes).content(text(content)); }

    public static NamedTag br(TypedAttributes.TypedAttribute ... attributes) { return new NamedTag(br, attributes); }
}