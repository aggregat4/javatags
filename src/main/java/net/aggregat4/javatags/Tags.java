...
public class Tags {
    ...
    public static final Attributes.Attribute[] NO_ATTRIBUTES = new Attributes.Attribute[0];

    public static Tag text(String content) { return new Text(content); }

    public static NamedTag html(Attributes.Attribute... attributes) { return new NamedTag(TagType.html, attributes); }
    ...
    public static NamedTag body(Attributes.Attribute... attributes) { return new NamedTag(body, attributes); }
    public static NamedTag body(Tag... children) { return body(NO_ATTRIBUTES).content(children); }

    public static NamedTag h1(Attributes.Attribute... attributes) { return new NamedTag(h1, attributes); }
    ...
    public static NamedTag p(Attributes.Attribute... attributes) { return new NamedTag(p, attributes); }
    ...
    public static NamedTag p(Attributes.Attribute[] attributes, String content) { return new NamedTag(p, attributes).content(text(content)); }

    public static NamedTag br(Attributes.Attribute... attributes) { return new NamedTag(br, attributes); }
}